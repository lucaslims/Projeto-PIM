...
{
    public partial class FormAttLocacao : Form
    {
        public FormAttLocacao()
        {
            InitializeComponent();
        }
        ...
        private void FormAttLocacao_Load(object sender, EventArgs e)
        {
            GridProdutos();
        }
        private void GridProdutos()
        {
            ...
            try
            {
                ...
                query = "select * from TB_CD_LOCACAO";
