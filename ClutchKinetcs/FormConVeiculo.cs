    ...
    public partial class FormConVeiculo : Form
    {
        ...
        private void GridProdutos()
        {
            ...
            try
            {
                ...
                query = "Select veiculo.ID,veiculo.Placa,veiculo.CHASSI,veiculo.DESCRICAO as DESCRICAO_VEICULO,cor.DESCRICAO as COR ," +
                    "modelo.DESCRICAO as MODELO,marca.DESCRICAO as MARCA,b.DESCRICAO as STATUS from TB_CD_VEICULO veiculo "+
                        "INNER JOIN TB_CD_VEICULO_COR cor on veiculo.COR_ID = cor.ID "+
                        "INNER JOIN TB_CD_VEICULO_MODELO modelo on veiculo.MODELO_ID = modelo.ID "+
                        "INNER JOIN TB_CD_STATUS_VEICULO b on veiculo.STATUS_ID = b.ID "+
                        "INNER JOIN TB_CD_VEICULO_MARCA marca on modelo.MARCA_ID = marca.ID;" ;
        ...
        private void FormConVeiculo_Load(object sender, EventArgs e)
        {
            GridProdutos();
        }
    }
